...
*/
graph_node * graph_add_node(graph * g, void* object);
...
/**
* Ritorna il nome del nodo n. Notare che e' possibile ottenere tale nome anche attraverso n->object.
*/
const void* graph_get_node_object(graph_node* n);
