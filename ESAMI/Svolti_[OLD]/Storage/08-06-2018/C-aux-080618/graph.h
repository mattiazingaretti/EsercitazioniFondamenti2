...
/**
* Ritorna la lista dei nodi del grafo g. Notare che è possibile ottenere questa lista anche attraverso g->nodes.
*/
linked_list * graph_get_nodes(graph * g);

/**
* Ritorna la lista degli archi incidenti ad n. Notare che è possibile ottenere questa lista anche attraverso n->incident_edges.
*/
...
/**
* Ritorna la chiave del nodo n. Notare che è possibile ottenere tale chiave anche attraverso n->key.
*/
int graph_get_node_key(graph_node * n);

/**
* Ritorna la chiave dell'arco n. Notare che è possibile ottenere tale chiave anche attraverso e->key.
*/
int graph_get_edge_key(graph_edge* e);

/**
* Ritorna la label del nodo n. Notare che è possibile ottenere tale label anche attraverso n->label.
*/
