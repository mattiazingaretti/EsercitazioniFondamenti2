public class Heap {
    ...
    private HEAP_TYPE type; // Heap minimale o massimale
    private int used; // Numero di elementi nell'array/heap

    static class HeapEntry {
        private int key;
        private int position; // In questo esercizio: sia valore che posizione
    }
    ...
    private void exchange(int i, int j) {
        ...
        this.array[i].position = i; // Heap consapevole della posizione
        this.array[j].position = j; // Heap consapevole della posizione
    }
    ...
    private void heapify(int i) {  // Questa è downheap del libro
